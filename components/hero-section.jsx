                        ...
                        <div className="mx-auto max-w-5xl px-6">
                            <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                                <TextEffect
                                    ...
                                    Expert Job Support For IT Professionals
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    At Job Support by Experts, we understand that keeping up with rapidly evolving technologies while handling workplace challenges can be overwhelming.
                                    With over 4 years of experience in guiding IT professionals, we provide end-to-end job support to help you perform confidently, meet project expectations, and achieve career growth — all with personalized expert guidance tailored to your specific role and technology stack.
                                </TextEffect>
